...
Yii::import('ext.bootstrap.widgets.TbGridView');// หากต้องการใช้ bootstrap grid
...
class tlbExcelView extends TbGridView //// หากต้องการใช้ bootstrap grid
{
    //the PHPExcel object
    ...
    public $exportButtons = array('Excel5'); // CSV ก็ได้
    ...
    public function renderRow($row)
    {
        ...
        foreach ($this->columns as $n => $column) {
            ...
            if (preg_match("/^[0-9]*\\" . $this->thousandsSeparator . "[0-9]*\\" . $this->decimalSeparator . "[0-9]*$/", strip_tags($value))) {
                ...
                //self::$activeSheet->getStyle('C2')->getNumberFormat()->setFormatCode('0000');
                $format = '0.00';
            } else {
