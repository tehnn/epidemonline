...
/**
 * This is the model class for table "point_amp".
 *
 * The followings are the available columns in table 'point_amp':
 * @property string $X
 * @property string $Y
 ...
 */
class PointAmp extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('X, Y, POLYTYPE, PROV_CODE, AMP_CODE, PROV_NAMT, PROV_NAME, AMP_NAMT, AMP_NAME', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return PointAmp the static model class
	 */
