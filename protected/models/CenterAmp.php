...
/**
 * This is the model class for table "center_amp".
 *
 * The followings are the available columns in table 'center_amp':
 * @property string $X
 * @property string $Y
 ...
 */
class CenterAmp extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('X, Y, POLYTYPE, PROV_CODE, AMP_CODE, PROV_NAMT, PROV_NAME, AMP_NAMT, AMP_NAME, KPI', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return CenterAmp the static model class
	 */
